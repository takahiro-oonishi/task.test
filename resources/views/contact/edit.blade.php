        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    editです
                    <form method="POST" action="{{route('contact.update', ['id'=> $contact->id ])}}"><!-- 保存のため、POST -->
                        @csrf

                        氏名
                        <input type="text" name="your_name" value="{{$contact->your_name}}"><br><!-- データベースの値をvalueに入れて表示 -->
                        件名
                        ...
                        性別
                        <!-- チェックボックスの場合、@if($contact->gender === 0 ) checked @endif でデータベースの値が、選択された状態になる -->
                        ...
                        <br>
                        年齢
                        <!-- セレクトの場合、@if($contact->age === 1 ) selected @endif でデータベースの値が、選択された状態になる -->
                        <select name="age">
